...
namespace IdentityServerHost.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        private readonly SignInManager<BeerUser> _signInManager;
        ...
        [HttpGet]
        public async Task<IActionResult> CreateFirstUser(string returnUrl)
        {
            ...
            return View(new CreateFirstIUserInputModel { ReturnUrl = returnUrl });
        }

        /// <summary>
        /// Handle postback from creating the first user
        /// </summary>
        [HttpPost]
        ...
        public async Task<IActionResult> Login(string returnUrl)
        {
            ...
            else
            {
                ...
                {
                    return RedirectToAction("CreateFirstUser", new { returnUrl = returnUrl });
                }
            }
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                ModelState.AddModelError(nameof(LoginInputModel.Password), _localizer[AccountOptions.InvalidCredentialsErrorMessage]);
                ModelState.AddModelError(nameof(LoginInputModel.Username), _localizer[AccountOptions.InvalidCredentialsErrorMessage]);
            }
