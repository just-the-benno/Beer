...
{
    public partial class DHCPv4ImportScopeStructureDialog : DaAPIDialogBase
    {
        ...
        public DHCPv4ImportScopeStructureDialog()
        {
            _jsonSettings =
        ...
        private Boolean IsInputValid(String input)
        {
            try
            {
                var requests =  JsonConvert.DeserializeObject<List<DHCPv4ExportRequest>>(input, _jsonSettings);
        ...
        private  async  Task StartImport()
        {
            ...
            var requests = JsonConvert.DeserializeObject<List<DHCPv4ExportRequest>>(_content, _jsonSettings);
