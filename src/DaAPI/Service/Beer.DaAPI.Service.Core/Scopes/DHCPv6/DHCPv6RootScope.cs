...
namespace Beer.DaAPI.Core.Scopes.DHCPv6
{
    public class DHCPv6RootScope : RootScope<DHCPv6Scope, DHCPv6Packet, IPv6Address, DHCPv6Leases, DHCPv6Lease, DHCPv6ScopeAddressProperties, DHCPv6ScopeProperties, DHCPv6ScopeProperty, UInt16, DHCPv6ScopePropertyType>
    {
        ...
        protected override DomainEvent CreateLeaseRemovedEvent(Guid scopeId, Guid leaseId) => new DHCPv6LeaseRemovedEvent(leaseId, scopeId);
        protected override DomainEvent CreateScopeDeletedEvent(Guid scopeId) => new DHCPv6ScopeDeletedEvent(scopeId);
