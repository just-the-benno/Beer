    ...
    public class DHCPv4DiscoveryRequestTester
    {
        ...
        public async Task SendAndReceive()
        {
            ...
            try
            {
                ...
                var initicalContext = DatabaseTestingUtility.GetTestDatabaseContext(dbName);
                ...
                services.AddSingleton<DbContextOptions<StorageContext>>(DatabaseTestingUtility.GetTestDbContextOptions(dbName));
                ...
                var initialRootScope = provider.GetService<DHCPv4RootScope>();
